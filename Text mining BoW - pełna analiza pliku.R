...
file_path <- "C:/Users/kubah/OneDrive/Pulpit/texts about the COVID-19 pandemic/Trudeau_C19.txt"
...
# Silnie pozytywne lub silnie negatywne słowa: filtrowanie analizy sentymentu i pozostawienie tylko słów o wartości w zakresie od -5 do 5
